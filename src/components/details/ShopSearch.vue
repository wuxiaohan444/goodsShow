  ...
  <div class="ShopSearch">
    ...
    <div class="searchAll">
      <div class="searchAllLeft">
        <ul>
          <!---->
          <li v-for="(item,index) in shopListAllWarp" :class="{div:changeRed == index}" :data="index"
        ...
        <div>
          ...
          <div class="priceRange" v-show="showarrPrice">
            ...
            <div class="sortDetail">
              <div :data-startPrice="item.lowPrice" :data-endPrice="item.highPrice"
                   v-for="(item,index) in arrPrice.productTypeSecondList" ref="sortPrice"
                   @click="sortDetail($event,index)">{{item.priceDesc}}
              </div>
            </div>
          </div>
          <!--  节庆商品  -->
          <div class="priceRange" v-show="showfestivalList">
            ...
            <div class="sortDetail">
              <div v-for="(item,index) in festivalList.productTypeSecondList" @click="sortPrice(index)">{{item.name}}
              </div>
            </div>
          </div>
          ...
          <div v-for="item in shopListOne.productTypeSecondList" v-show="showShopListOne">
            <div class="searchDetails">
              ...
              <div class="sortDetailsAll">
                <div class="sortDetails" v-for="(items,index) in item.productTypeThirdList"
                     @click="sortDetails(items.id)">
                  <div class="searchOne">
                    <p>
